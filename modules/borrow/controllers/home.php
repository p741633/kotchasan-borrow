...
class Controller extends \Gcms\Controller
{
    ...
    public static function addCard(Request $request, $card, $login)
    {
        if ($login) {
            ...
            \Index\Home\Controller::renderCard($card, 'icon-valid', $login['name'], number_format($items->confirmed), '{LNG_Borrow} &amp; {LNG_Return} '.Language::get('BORROW_STATUS', null, 2), 'index.php?module=borrow-report&amp;status=2');
